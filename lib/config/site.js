...
var title = 'Web全栈论坛';
var fullname = 'Web全栈开者交流社区';
var host = 'server.xiv.im';

module.exports = {
  name: fullname,
  title: process.env.FORIM_TITLE || title,
  description: process.env.FORIM_DESCRIPTION || 'Web全栈开者交流社区', // 社区的描述
  keywords: process.env.FORIM_KEYWORDS || 'Web全栈开发者',
  logo: '',
  favicon: '',
  meta: {
  ...
  auth: {
    session: {
      secret: process.env.FORIM_SESSION_SECRET || 'node_weixin_secret' // 务必修改
    },
    cookie: {
      name: process.env.FORIM_COOKIE_NAME || 'node_weixin_cookie'
    }
  },
  host: host,
  server: {
  ...
  client: {
    ...
    rss: {
      ...
      description: process.env.FORIM_RSS_DESCRIPTION || 'Web全栈开发社区',
      // 最多获取的RSS Item数量
